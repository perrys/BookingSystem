...
if (($stagger == 55) OR ($stagger == 56)) {$book = 1;}
			...
			if(!isset($id))
			{
				...
				if ( $pview != 1 ) {
					...
					if ( $book == 0) {
					echo "<a href=\"edit_entry_fixed.php?area=$area&room=$room&hour=$hour&minute=$minute&year=$year&month=$month&day=$day\"><img src=new.gif width=10 height=10 border=0></a>";
					} else {echo "&nbsp;";}
