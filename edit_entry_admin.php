...
// Demo does not have this line as n-weekly repeat bookings now removed.
...
<FORM NAME="main" ACTION="edit_entry_handler_admin.php" METHOD="GET">
...
<tr><td class=CR><b><?php echo get_vocab("rooms") ?>:</b></td>
  ...
  ?>
  </select></td><td>Use Control-Click to select more than one court</td></tr></table>
    </td></tr>
...
<TR> <TD CLASS=CR></TD> <TD CLASS=CL>Use n-weekly if you want one booking every n weeks (e.g. for one booking every 4 weeks set n=4)</TD></TR>
